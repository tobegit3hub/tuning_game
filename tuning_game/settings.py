"""
Django settings for tuning_game project.
...
SECRET_KEY = '6sjb&49(k#dex12o##s579bn4cek)-equj2k#$6*ya%c83(uxz'
...
WSGI_APPLICATION = 'tuning_game.wsgi.application'
...
REGISTERED_COMPETITION = {
    ...
    "tuning.competition.two_unknow_quadratic_equation",
}
